    ...
    (b = (function () {
            ...
            if (b.options.swipeToSlide === !0) {
                ...
                return (
                    b.$slideTrack.find(".slick-slide").each(function (c, e) {
                        return e.offsetLeft + a(e).outerWidth() / 2 >
                            -1 * b.swipeLeft
                            ? ((d = e), !1)
                            : void 0;
                    }),
        ...
        (b.prototype.setDimensions = function () {
            ...
            if (
                ...
                (b.slideWidth = Math.ceil(
                    b.listWidth / b.options.slidesToShow
                )),
                    b.$slideTrack.width(
                        Math.ceil(
                            b.slideWidth *
            ...
            var d =
                b.$slides.first().outerWidth(!0) - b.$slides.first().width();
                    ...
                    : (b === !1 && j.asNavFor(a),
                      ...
                      (0 > a || a > j.getDotCount() * j.options.slidesToScroll)
                          ...
                          : j.options.infinite === !1 &&
                            ...
                            (0 > a ||
                                a > j.slideCount - j.options.slidesToScroll)
                          ? (j.options.fade === !1 &&
                                ((d = j.currentSlide),
                                c !== !0
                                    ? j.animateSlide(g, function () {
                ...
                a.options.arrows === !0 &&
                    ...
                    0 === a.currentSlide
                        ...
                        ? (a.$nextArrow.addClass("slick-disabled"),
                          a.$prevArrow.removeClass("slick-disabled"))
                        : a.currentSlide >
                              a.slideCount - a.options.slidesToShow + b &&
